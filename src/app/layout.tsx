              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:text-right">
                  ...
                  <div className="flex md:justify-end gap-4">
                    <a href="https://x.com/Terratrust" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-400 hover:text-zinc-100 transition-colors">X</a>
                    <a href="https://discord.gg/Terratrust" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-400 hover:text-zinc-100 transition-colors">Discord</a>
                    <a href="https://github.com/Terratrust" target="_blank" rel="noopener noreferrer" className="text-sm text-zinc-400 hover:text-zinc-100 transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
